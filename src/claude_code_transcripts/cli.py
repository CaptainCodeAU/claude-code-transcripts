"""CLI layer: click + questionary command group and entry points.

Imports from the render/fetch/core layers plus notify/spawn. The URL-fetch and
gist helpers that raise click.ClickException live here so the fetch layer stays
click-free.
"""
