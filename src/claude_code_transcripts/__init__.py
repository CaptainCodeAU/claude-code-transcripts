...
# --- render layer re-exports (lazy split; see render/) ---
from .render.env import get_macros, get_template
from .render.assets import CSS, JS
from .render.markdown_ext import render_markdown_text
...
from .render.gist import inject_gist_preview_js, GIST_PREVIEW_JS
from .render.indexes import _generate_project_index, _generate_master_index
...
# --- fetch layer re-exports (lazy split; see fetch/) ---
from .fetch.credentials import (
    CredentialsError,
    get_access_token_from_keychain,
    get_org_uuid_from_config,
)
from .fetch.api import (
    API_BASE_URL,
    ANTHROPIC_VERSION,
    get_api_headers,
    fetch_sessions,
    fetch_session,
    _fetch_teleport_events,
